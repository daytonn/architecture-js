...
Gem::Specification.new do |s|
  ...
  s.date = "2011-12-16"
  s.description = "Architecture.js is a tool to build and manage javascript applications and frameworks. Architecture.js helps you generate scaffolding, manage third-party packages, compile, and compress your application."
